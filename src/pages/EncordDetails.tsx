...
const EncordDetails = () => {
  ...
  const showContactButton = isInNetwork("Encord");
  const { 
    isEditMode, 
    setIsEditMode, 
    handlePublish, 
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                Detailed information for Encord is coming soon.
              </p>
            </CardContent>
          </Card>
