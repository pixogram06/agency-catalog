...
const RoamlerDetails = () => {
  const navigate = useNavigate();
  const showContactButton = isInNetwork("Roamler");
  const { 
    isEditMode, 
    setIsEditMode, 
    handlePublish, 
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                Detailed information for Roamler is coming soon.
              </p>
            </CardContent>
          </Card>
