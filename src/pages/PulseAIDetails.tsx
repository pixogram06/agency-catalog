...
const PulseAIDetails = () => {
  const navigate = useNavigate();
  const showContactButton = isInNetwork("Pulse.AI");
  const { 
    isEditMode, 
    setIsEditMode, 
    handlePublish, 
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                Detailed information for Pulse.AI is coming soon.
              </p>
            </CardContent>
          </Card>
          ...
          {/* Danger Zone */}
          <DangerZone agencyName="Pulse.AI" />
        </div>
      </div>
    </div>
  );
