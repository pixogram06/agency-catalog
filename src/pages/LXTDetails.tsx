...
const LxtDetails = () => {
  ...
  const showContactButton = isInNetwork("LXT");
  const { 
    isEditMode, 
    setIsEditMode, 
    handlePublish, 
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                Detailed information for LXT is coming soon.
              </p>
            </CardContent>
          </Card>
