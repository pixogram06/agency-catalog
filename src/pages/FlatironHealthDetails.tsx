...
const FlatironHealthDetails = () => {
  const navigate = useNavigate();
  const showContactButton = isInNetwork("Flatiron Health");
  const { 
    isEditMode, 
    setIsEditMode, 
    handlePublish, 
    ...
    editOtsDataList,
    setEditOtsDataList,
  } = useEditableAgency("Flatiron Health");
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                Detailed information for Flatiron Health is coming soon.
              </p>
            </CardContent>
          </Card>
          ...
          {/* Danger Zone */}
          <DangerZone agencyName="Flatiron Health" />
        </div>
      </div>
    </div>
  );
...
export default FlatironHealthDetails;
