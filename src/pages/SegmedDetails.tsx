...
const SegmedDetails = () => {
  ...
  const showContactButton = isInNetwork("Segmed");
  const { 
    isEditMode, 
    setIsEditMode, 
    handlePublish, 
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                Detailed information for Segmed is coming soon.
              </p>
            </CardContent>
          </Card>
