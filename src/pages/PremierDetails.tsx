...
const PremierDetails = () => {
  ...
  const showContactButton = isInNetwork("Premier");
  const { 
    isEditMode, 
    setIsEditMode, 
    handlePublish, 
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                Detailed information for Premier is coming soon.
              </p>
            </CardContent>
          </Card>
