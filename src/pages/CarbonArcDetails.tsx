...
const CarbonArcDetails = () => {
  const navigate = useNavigate();
  const showContactButton = isInNetwork("Carbon Arc");
  const { 
    isEditMode, 
    setIsEditMode, 
    handlePublish, 
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                Detailed information for Carbon Arc is coming soon.
              </p>
            </CardContent>
          </Card>
          ...
          {/* Danger Zone */}
          <DangerZone agencyName="Carbon Arc" />
        </div>
      </div>
    </div>
  );
...
export default CarbonArcDetails;
