...
const SermoDetails = () => {
  ...
  const showContactButton = isInNetwork("Sermo");
  const { 
    isEditMode, 
    setIsEditMode, 
    handlePublish, 
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                Detailed information for Sermo is coming soon.
              </p>
            </CardContent>
          </Card>
