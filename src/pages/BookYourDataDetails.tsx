...
const BookYourDataDetails = () => {
  const navigate = useNavigate();
  const showContactButton = isInNetwork("Book Your Data");
  const { 
    isEditMode, 
    setIsEditMode, 
    handlePublish, 
    ...
    editOtsDataList,
    setEditOtsDataList,
  } = useEditableAgency("Book Your Data");
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                Detailed information for Book Your Data is coming soon.
              </p>
            </CardContent>
          </Card>
          ...
          {/* Danger Zone */}
          <DangerZone agencyName="Book Your Data" />
        </div>
      </div>
    </div>
  );
...
export default BookYourDataDetails;
