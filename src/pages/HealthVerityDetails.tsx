...
const HealthVerityDetails = () => {
  const navigate = useNavigate();
  const showContactButton = isInNetwork("Health Verity");
  const { 
    isEditMode, 
    setIsEditMode, 
    handlePublish, 
    ...
    editOtsDataList,
    setEditOtsDataList,
  } = useEditableAgency("Health Verity");
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                Detailed information for Health Verity is coming soon.
              </p>
            </CardContent>
          </Card>
          ...
          {/* Danger Zone */}
          <DangerZone agencyName="Health Verity" />
        </div>
      </div>
    </div>
  );
...
export default HealthVerityDetails;
