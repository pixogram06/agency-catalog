...
const ZyteDetails = () => {
  ...
  const showContactButton = isInNetwork("Zyte");
  const { 
    isEditMode, 
    setIsEditMode, 
    handlePublish, 
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                Detailed information for Zyte is coming soon.
              </p>
            </CardContent>
          </Card>
