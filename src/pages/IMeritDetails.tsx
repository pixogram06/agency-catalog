...
const ImeritDetails = () => {
  ...
  const showContactButton = isInNetwork("iMerit");
  const { 
    isEditMode, 
    setIsEditMode, 
    handlePublish, 
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                Detailed information for iMerit is coming soon.
              </p>
            </CardContent>
          </Card>
