...
const IqviaDetails = () => {
  ...
  const showContactButton = isInNetwork("IQVIA");
  const { 
    isEditMode, 
    setIsEditMode, 
    handlePublish, 
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground leading-relaxed">
                Detailed information for IQVIA is coming soon.
              </p>
            </CardContent>
          </Card>
